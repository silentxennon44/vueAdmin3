...
export default createI18n({
  locale: localCache.getCache('language')??import.meta.env.VITE_DEFAULT_LOCALE, // <--- 1
  ...
  missing: (locale, key, vm, values) => {
    ...
    return import.meta.env.MODE === 'development'? "i18N: MISSING" : ""; // return an empty string as the fallback value
  },
})
